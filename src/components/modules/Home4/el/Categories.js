...
const categoryListFour= [
    ...
    },
    {
        ...
        "title": "ΜΟΥΣΙΚΗ",
        "description": "Μάθε αγγλικά και γερμανικά με παιχνίδια, τραγούδια και δραστηριότητες που κάνουν το λεξιλόγιο και τη γραμματική διασκεδαστικά."
    },
    {
        "icon": "https://thetork.com/demos/vue/educax/images/category/home4/3.png",
        "title": "ΣΥΝΕΡΓΑΣΙΑ",
        "description": "Μαθαίνουμε καλύτερα μαζί! Με συνεργασία, χαρά και αλληλοϋποστήριξη, κάθε μαθητής προχωράει με θάρρος, αυτοπεποίθηση και ενθουσιασμό."
    },
    {
        "icon": "https://thetork.com/demos/vue/educax/images/category/home4/4.png",
        "title": "ΠΑΙΧΝΙΔΟΠΟΙΗΣΗ",
        "description": "Μαθαίνεις, παίζοντας! Εκπαιδευτικά παιχνίδια που κάνουν τη γλώσσα συναρπαστική και μετατρέπουν κάθε μάθημα σε περιπέτεια."
    }
]
const Categories = () => {
  return (
